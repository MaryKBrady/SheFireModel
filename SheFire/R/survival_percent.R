...
#' 
#' chamaecrista.seeds2cm <- survival_percent(x = 2, deltaS = 112, deltaH = 147741, model = model_example) #default temporal resolution and temp. Chamaecrista (cassia) seed survival, for parameters see Martin et al (1969)
